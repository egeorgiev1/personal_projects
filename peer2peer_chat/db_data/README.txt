Start he DatabaseManager SWingUI by running the following command in the db_data directory
...
Look at the files that were created in the db_data directory. Your newly created database is stored in myDBfilestore.script.
...
with limited privileges which will be used to access the tables from our program.
