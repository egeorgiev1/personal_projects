...
model.load_weights("weights-10-0.01.hdf5")

test_case = next(testing_generator)
...
ground_truth_figure = figure.add_subplot(1, 2, 1)
ground_truth_figure.title.set_text('Ground Truth')
plt.imshow(test_case[1][0, :, :, :], cmap = plt.cm.gray)

predicted_figure = figure.add_subplot(1, 2, 2)
predicted_figure.title.set_text('Prediction')
plt.imshow(prediction_result[0, :, :, :], cmap = plt.cm.gray)
plt.show()
